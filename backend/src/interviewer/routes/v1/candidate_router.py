...
from interviewer.model.credits_models import LOW_BALANCE_WARN
from interviewer.service.metering.keyvault_service import RejectedKey

from ...security.auth import current_candidate
from ...wiring import wiring
from .operator_router import _guard as operator_only
...
async def topic_standing(
    ...
    from interviewer.model.standing_models import Standing
...
async def coverage_standing(
    ...
    from interviewer.model.standing_models import CoverageStanding
    ...
    standing = CoverageStanding.of(
        candidate_id=candidate_id,
        examined=CoverageStanding.examined_counts(await confidence.posteriors_on(shared_topics)),
