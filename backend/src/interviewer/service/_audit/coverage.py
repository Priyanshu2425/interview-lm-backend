...
_MAP: dict[str, list[tuple[str, str, str]]] = {
    ...
    "0002": [
        ...
        ("12",    "service/graph/machine.py:select_topic", "test_selection.py"),
        ("13-14", "service/confidence/selector.py",        "test_selection.py"),
        ("15-17", "service/graph/machine.py:select_topic", "test_walking_skeleton.py"),
    ...
    "0003": [
        ...
        ("4",     "service/graph/machine.py:select_topic", "test_selection.py"),
        ...
        ("12-13", "service/graph/machine.py:update_confidence","test_judge.py"),
        ...
        ("27",    "service/graph/machine.py:record_answer","test_judge.py"),
    ...
    "0005": [
        ...
        ("8",     "service/graph/machine.py:update_confidence","test_judge.py"),
