...
from ..confidence.math import Posterior
from ..confidence.store import ConfidenceStore, EvidenceLedger, VisitLifecycle
from ..corpus.citations import resolve
from ..corpus.contract import GradingMode
from ..corpus.loader import DossierLoader
from ..corpus.service import CorpusService
from ..judge.interviewer import Interviewer
from ..judge.judge import Judge
from ..judge.question_writer import QuestionWriter
...
def build_graph(d: Deps):
    ...
    def select_topic(state: SessionState) -> dict:
        ...
        if d.bindings is not None:
            from ..metering.client import Binding
    ...
    def decide_next(state: SessionState) -> dict:
        ...
        if d.credits is not None and _route(state) == "credits":
            from ..metering.credits import clears_headroom
