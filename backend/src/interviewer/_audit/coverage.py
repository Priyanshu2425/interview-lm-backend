...
_MAP: dict[str, list[tuple[str, str, str]]] = {
    ...
    "0001": [
        ...
        ("10",    "corpus/adapters/cortex.py",     "test_corpus_contract.py"),
        ...
        ("14",    "corpus/adapters/cortex.py",     "test_corpus_contract.py"),
        ...
        ("28",    "corpus/adapters/cortex.py",     "test_architecture.py"),
